...
<?php echo $form->text('UstreamURL', $UstreamURL, array('style' => 'width: 320px'));?><br /><br /><br />
<?php echo $form->label('ImageType', t('Image Type'));?>
<?php echo $form->hidden('ImageType', 0);?>
<?php echo $form->radio('ImageType', 1, $ImageType);?> <?php echo t('Small (88x31 pixels)');?><br />
...
<?php echo $form->radio('ImageType', 2, $ImageType);?> <?php echo t('Medium (190x80 pixels))');?><br />
...
<?php echo $form->radio('ImageType', 3, $ImageType);?> <?php echo t('Medium Large (300x120 pixels)');?><br />
